...
//         <input id="search" name="search"  style={{height: "20px", marginLeft: "10px"}} type="text" className="search-input" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} />
//       </div>
